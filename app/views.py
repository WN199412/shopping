...
from app.models import User, Manage, Order, Mdelu, track, Ad, Category, Shangp, Details, Size, System, Eval
...
def index(request):
    ...
    su = num + num2 + num3
    return render(request,'index.html',context={'name':name,'num':num,'num2':num2,'num3':num3,'su':su})
...
def Brand_Manage(request):
    ...
    if tt == "停用":
        ...
        pi.zh = 0
        pi.save()
    return render(request,'Brand_Manage.html',context={'shuju':shuju,'shuju1':shuju1})
